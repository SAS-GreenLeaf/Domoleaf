CREATE TABLE IF NOT EXISTS `mcuser_floor` (
  ...
  `floor_posx` int(10) unsigned NOT NULL DEFAULT '0',
  `floor_posy` int(10) unsigned NOT NULL DEFAULT '0',
  `floor_counter` int(10) unsigned NOT NULL DEFAULT '0',
  KEY `mcuser_id` (`mcuser_id`),
  KEY `floor_id` (`floor_id`),
  KEY `floor_counter` (`floor_counter`),
