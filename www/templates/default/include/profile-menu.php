...
echo '<div class="col-xs-2 bhoechie-tab-menu sidebar">
			<div class="list-group">
				...
				<a title="'._('Scenarios').'" href="/profile_user_scenarios" class="list-group-item text-center">
					<h4 class="fi flaticon-playbutton17 lg"></h4><br/><span class="hidden-xs">'._('Scenarios').'</span>
				</a>
			</div>
		</div>';
