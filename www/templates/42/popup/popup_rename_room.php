...
<div class="controls center">	
	...
	<select class="form-control" id="changefloor">';
...
echo '</select>
	<button  id="eventSave" onclick="RoomManager('.$_GET['idroom'].')" class="btn btn-greenleaf">'._('Save').' <span class="glyphicon glyphicon-ok"></span></button><button onclick="popup_close()" class="btn btn-danger">'._('Cancel').' <span class="glyphicon glyphicon-remove"></span></button>
</div>';
