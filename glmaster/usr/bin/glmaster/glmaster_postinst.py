...
def master_conf_initdb():
    ...
    Popen(['mysql', '--defaults-file=/etc/mysql/debian.cnf', 'domoleaf',
           '-e', query3], stdin=PIPE, stdout=PIPE, stderr=PIPE, bufsize=-1);
    Popen(['mysql', '--defaults-file=/etc/mysql/debian.cnf', 'domoleaf',
           '-e', query4], stdin=PIPE, stdout=PIPE, stderr=PIPE, bufsize=-1);
    Popen(['mysql', '--defaults-file=/etc/mysql/debian.cnf', 'domoleaf',
           '-e', query5], stdin=PIPE, stdout=PIPE, stderr=PIPE, bufsize=-1);
